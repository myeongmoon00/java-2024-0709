...
//protected : 같은 패키지 내부 혹은 외부패키지의 자손 클래스에서 접근 가능
...
class AccessModifierRun {
	...
	void method() {
		...
		//AccessModifier의 publicVariable, protectedVariable, defaultVariabl 필드는
		//접근제어자가 각각 default, protected, public이기 때문에 같은 패키지 내부에서 접근 가능
		instance.defaultVariable = 0;
		instance.protectedVariable = 0;
		instance.publicVariable = 0;
		
		//AccessModifier의 privateVariable 필드는
		//접근제어자가 private이고 다른 클래스 이기 때문에 접근 불가능
