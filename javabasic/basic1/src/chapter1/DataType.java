...
//	int1 = 2_147_483_64L;
	...
	//가장 많이 사용되는 정수형 타입은 int형이다.
	//byte, short 메모리 공간을 절약할때 사용되는 정수형 타입
	//큰 수를 다룰 대 사용되는 정수형 타입은 long 
	...
	float float1 = 3.14149265343423423434234F;
	System.out.println(float1);
	//double : 8byte(64bit)의 크기를 가지는 실수형 데이터 타입
	//소수점 15-17자리에서 오차가 발생
	double double1 = 3.142423232383784924;
	...
	//자동 형변환 : 작은 데이터 타입의 변수를 큰 데이터 타입의 변수에 옮겨 닮을때 발생
	
	//강제 형변환 : 큰 데이터 타입의 변수를 작은 데이터 타입의 변수에 옮겨 닮을때 발
...
//	System.out.println(numbers3[99]);
	...
	statement = "내가 그린 기린 그림은 잘 그린 기린 그림이고 네가 그린 그림은 잘 못 그린 기린 그림이다.";
	System.out.println(statement.indexOf("기린"));
	System.out.println(statement.indexOf("사자")); //-1 반환
	System.out.println(statement.lastIndexOf("기린"));
	System.out.println(statement.lastIndexOf("사"));
