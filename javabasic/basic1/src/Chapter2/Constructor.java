...
class Human1{
	...
	Human1(){				//메서드지만 반환타입X
		...
		//의존성을 내부에서 주입하는 행위 -> 의존성 역천의 관계에 따라 지향 하기!!!!!!!!!!!
		name = "홍길동";
		age = 20;
		gender = "남";
		address = "부산";
	...
	void great() {
		//name에 의존하고 있는 형태
		System.out.println(name.concat("이 인사를 합니다")); //NullPointException->name은 Human1의 인스턴스변수에 의존 즉 NULL이면  에러발생
...
public class Constructor {
	...
	public static void main(String[] args) {
		...
		Human1 human3 = new Human1("이영희", 30, "");
